...
type EnvSettings struct {
	GRPCBindAddress string `env:"GRPCBINDADDR" env-default:":50052" env-description:"IP:PORT to bind grpc"`                                //nolint:lll
...
func (c *Config) GetUsersCUDGroupID() string {
	return c.env.UsersCUDGroupID
}
