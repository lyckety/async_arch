...
func (u *UpdatedUserV1) name() string {
	return "UpdatedUser"
}

func (u *UpdatedUserV1) version() int {
	return 1
}

func (u *UpdatedUserV1) validate() error {
	if u.EventTime == 0 {
...
func (u *UpdatedUserV1) toPB() (*pbV1Updated.Event, error) {
