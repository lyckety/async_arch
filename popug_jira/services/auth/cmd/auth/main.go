...
import (
	...
	"github.com/lyckety/async_arch/popug_jira/services/auth/internal/app"
	"github.com/lyckety/async_arch/popug_jira/services/auth/internal/config"
	db "github.com/lyckety/async_arch/popug_jira/services/auth/internal/db/postgresql"
...
func main() {
	...
	app := app.New(
		&app.Config{
			...
			MBPartition:     cfg.GetPartition(),
			MBTopic:         cfg.GetTopicName(),
			JWTTokenExpired: cfg.GetJWTTokenExpired(),
		},
		database,
	)
