...
import (
	...
	pbV1 "github.com/lyckety/golang-base-service/pkg/grpc/database/v1"
...
type DatabaseService struct {
	pbV1.UnimplementedDatabaseServiceServer

	dbIns domain.Repository
}

func New(db domain.Repository) *DatabaseService {
	return &DatabaseService{
		dbIns: db,
	}
}

func (s *DatabaseService) CreateOrUpdateUser(
	ctx context.Context,
...
func (s *DatabaseService) GetAllUsers(
	ctx context.Context,
...
func (s *DatabaseService) GetUserByName(
	ctx context.Context,
