...
import (
	...
	"github.com/lyckety/golang-base-service/internal/app/consumer"
	dbSrv "github.com/lyckety/golang-base-service/internal/app/database"
	"github.com/lyckety/golang-base-service/internal/app/producer"
	"github.com/lyckety/golang-base-service/internal/db/domain"
	pbV1DB "github.com/lyckety/golang-base-service/pkg/grpc/database/v1"
	pbV1Cons "github.com/lyckety/golang-base-service/pkg/grpc/kafkaconsumer/v1"
	pbV1Prod "github.com/lyckety/golang-base-service/pkg/grpc/kafkaproducer/v1"
...
func New(cfg *Config, db domain.Repository) *App {
	...
	pbV1DB.RegisterDatabaseServiceServer(server, dbService)
