...
const (
	KafkaConsumerService_SubscribeTopic_FullMethodName = "/kafkaconsumer.v1.KafkaConsumerService/SubscribeTopic"
)
...
func (c *kafkaConsumerServiceClient) SubscribeTopic(ctx context.Context, in *SubscribeTopicRequest, opts ...grpc.CallOption) (KafkaConsumerService_SubscribeTopicClient, error) {
	stream, err := c.cc.NewStream(ctx, &KafkaConsumerService_ServiceDesc.Streams[0], KafkaConsumerService_SubscribeTopic_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
